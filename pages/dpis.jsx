...
import dpisimg from '../public/assets/projects/dpis.jpg';
    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p>
            This appplication was built using PHP and MYSQL and is styled with
          ...
          <a
            href='https://github.com/KabboN/DPIS'
            target='_blank'
            rel='noreferrer'
          >
